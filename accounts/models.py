...
class Account(AbstractBaseUser):
    ...
    validity = models.IntegerField(default=30)  # Validity in days as integer
    ...
    org = models.ForeignKey(Org, on_delete=models.CASCADE, null=False, blank=False, default = "Bodhiguru")
